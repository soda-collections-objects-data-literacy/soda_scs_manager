...
class SodaScsNextcloudServiceActions implements SodaScsServiceRequestInterface {
   ...
   *
   * File filtering is done in SodaScsNextcloudPreview: the built-in `files`
   * filter omits types such as public_links_upload and returns HTTP 304 when
   * empty.
   *
  ...
  public function buildActivityRequest(array $requestParams): array {
    ...
    $limit = max(1, (int) ($requestParams['limit'] ?? 50));
