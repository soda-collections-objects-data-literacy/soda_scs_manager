...
final class SodaScsComponentAccessControlHandler extends EntityAccessControlHandler {
  ...
  protected function checkAccess(EntityInterface $entity, $operation, AccountInterface $account): AccessResult {
    ...
    return match($operation) {
      'view' => AccessResult::allowedIfHasPermission($account, 'view soda scs component'),
      'update' => AccessResult::allowedIfHasPermission($account, 'edit soda scs component'),
      'delete' => AccessResult::allowedIfHasPermission($account, 'delete soda scs component'),
